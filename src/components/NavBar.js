      ...
      <div className="container mx-auto flex justify-between">
        <nav className="flex">
          <NavLink
            to="/"
            exact
            className="inline-flex items-center py-6 px-3 mr-4 text-white hover:text-green-800 text-4xl font-bold cursive tracking-widest"
        ...
        <div className="inline-flex py-3 px-3 my-6">
            ...
            <SocialIcon url="https://mail.google.com/mail/u/0/?tab=wm#inbox" className="mr-4" target="_blank" fgColor="#fff" style={{ height: 35, width: 35 }} />
        </div>
      </div>
    </header>
  );
